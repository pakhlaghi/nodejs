...
const Home = (props) => {
    ...
    return (<div>
        ...
        <ul>
            <li><Link to={`${match.url}/test1`}>Technology</Link></li>
            <li><Link to="/home/business">Business</Link></li>
            <li><Link to="/home/economics">Economics</Link></li>
        </ul>

        <div>
        {
            home.showSpinner ? <span>loading...</span> : <div>
                app1
        ...
        <div>
            ...
            <ul>
                {home.users.map(person => <li key={person.id}>{person.name}</li>)}
            </ul>
        </div>
